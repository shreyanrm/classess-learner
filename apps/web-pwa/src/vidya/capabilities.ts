/**
 * Vidya's capability registry — her governed hands in the product (VIDYA.md §4). She never
 ...
 * outcome — taken or ignored — lands on the event backbone as vidya.offer.outcome.v1.
 */
...
const CAPABILITIES: Record<CapabilityId, VidyaCapability> = {
  open_course: {
    id: 'open_course',
  ...
  prepare_parent_note: {
    ...
    // it communicates beyond the learner — always explicit approval (VIDYA.md §4)
    rung: 'execute_with_permission',
...
export function capabilityById(id: string): VidyaCapability | undefined {
