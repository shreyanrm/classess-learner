/**
 * The five generative-UI paths (VIDYA.md §6) — the taxonomy is the contract. Every Vidya turn
 ...
 * (services/gateway/src/classess_gateway/vidya.py) — say/actions stay untouched; path payloads
 * ride alongside.
 */
...
export interface ActionAttachment {
  ...
  /** Correlates the shown card with its vidya.offer.outcome.v1 event. */
  offerId: string;
