...
packages (`@classess/ui`, `@classess/motion`, `@classess/vidya`) are currently **React DOM** (they
...
- A `VidyaPresence`/`VidyaPanel` RN implementation (Reanimated) honouring the same locked identity.
