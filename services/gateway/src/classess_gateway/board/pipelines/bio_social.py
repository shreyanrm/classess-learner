...
fact base; a Punnett square's cells and ratio come from :mod:`classess_gateway.plexus.bio`; a map
...
#: The parts of the diagrams she is asked for most, in the order a teacher labels them (outside
#: in). Curated rather than generated, and cross-checked against the fact base when it covers the
#: concept — a label she cannot support is not drawn.
...
def _punnett(intent: dict[str, Any], draft: Draft) -> Draft:
    from classess_gateway.plexus.bio import phenotype_ratio, punnett_cross, valid_genotype
