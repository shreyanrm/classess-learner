...
Regenerate with: ``uv run python -m classess_gateway.plexus.codegen`` (schema) then the bun
wiring (``bun run --filter @classess/contracts codegen``) for the TypeScript.
"""
