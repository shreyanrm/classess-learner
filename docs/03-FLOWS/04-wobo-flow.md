...
**WHEN:** learner taps Wobo, or the learn loop invokes Wobo on a struggle threshold. Not during unaided Practice.
...
remembers you. Wobo makes the product feel taught, not delivered.

**WHAT (steps):**
1. **Perceive** *(keystone)* — Wobo reads the learner's current working from the **app event/state stream** (canvas expressions/strokes,
...
3. **Reason grounded in correctness** — Wobo proposes steps; the **verifier checks** before Wobo commits. Wobo never free-styles math.
