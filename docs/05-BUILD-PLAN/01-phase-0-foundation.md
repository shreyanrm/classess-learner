...
2. **Event contract** (`/packages/contracts`): the `WoboEvent` envelope + initial typed payloads + the event taxonomy. Mirror types into python services. **This is the first real code.**
