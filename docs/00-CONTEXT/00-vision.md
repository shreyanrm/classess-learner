...
Strategic role: top-of-funnel for the whole ecosystem (the Physics Wallah pattern).
...
- **Template door**: board → grade → subject → chapter-as-course → topics + practice. Acquisition/trust.
- **Create-anything door**: learner-defined courses, generated and ontology-mapped. Retention/moat.
- Both compile to **one verified sequence of ontology nodes**. The orchestrator decides modality, sequence,
  and repetition per learner until mastery is demonstrated.

## The brand idea (carries into every screen)
**Black and white is the world before you understand something. Color is what understanding looks like.**
Concepts arrive monochrome; mastering one makes it *ignite* into its content-color. No signature brand hue —
color is earned, never decoration. (Full system in `02-DESIGN/`.)

## Audience & first proof
Grade 6 / equivalent and up, all Indian boards first (CBSE and equivalents), no hard age bar.
First proving vertical: **middle-school math**. First proof topic ("the atom"):
