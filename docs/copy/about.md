...
Page copy for heywobo.com/about. Sentence case, no emoji, no exclamation marks. One hit of pigment on this page: the ultramarine of Wobo's ink in the live drawing at the top. Every claim here is one the product actually keeps.
...
**Body**
Most children are taught to a room. The room moves at one pace, on one example, in one language, and if you fall behind on Tuesday nobody notices until the exam.
...
If nothing official exists, show Wobo yours. A photo of the syllabus page, a PDF, or just type it out, and Wobo builds a plan around it.
...
**Body**
[Company legal name] is a small team building one thing properly.

[Team placeholder — names, roles and one line each, added by the owner. Keep it to people who actually work on Wobo, with a photograph and a sentence about what they build. No stock portraits, no advisory board padding.]

**Careers line**
We hire rarely and carefully. If you build teaching tools the way we do, write to [careers email] and show us something you made.

---

## Footer block for this page
...
| Wobo the character | Character; also answers the gender question once, publicly, so nobody has to ask |
| Team | Trust; a real company with a real address |
| Footer links | Task: legal and support reachable from the page that earns trust |

Nothing else ships on this page. No logo wall, no press strip, no counter of learners taught, no testimonials.
