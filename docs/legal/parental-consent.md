...
> **In plain words**
>
> If the learner is under 18, we ask a parent or guardian to say yes before Wobo starts remembering them.
>
> We verify that you are a real adult, we tell you exactly what each feature does with your child's data, and you tick only the ones you want. Nothing is pre-ticked.
>
> Your child can learn either way. Consent switches on memory, voice, photographs and sharing, not the teaching itself.
>
> You can change your mind at any time, feature by feature, and the data behind a feature you switch off is deleted.
...
We ask for a parent's or guardian's verifiable consent when the learner is:
...
Above those ages, the learner consents for themselves, and we still write to them in language they will actually understand, and still keep the parent controls available if the learner turns them on.
...
## 3. The notice a parent sees

This is the wording. It appears on one page, in plain language, before anything is ticked.
...
## 4. What happens after you consent
...
| Delete one item, the memory, or the whole account | parent controls, delete |
| Switch a feature off and delete the data behind it | parent controls, permissions |
| Withdraw consent altogether | parent controls, or by writing to us. Your child keeps the basic learning experience |
| Refuse further collection while your child keeps learning | write to us and say so |
| Stop every optional message | the settings page, or the link in any message |

We do not ask you to explain why, we do not offer you a retention argument on the way out, and we do not hide the delete control behind a support conversation. Deleting is a button.

We respond within 30 days, usually far sooner, and we confirm in writing when a deletion is done. [REVIEW: response-time obligations per jurisdiction.]
