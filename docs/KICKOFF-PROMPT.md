...
------------------------------------------------------------------------------------------------------
You are my full engineering team building **Classess Learner**, the flagship B2C AI-native learning app of the
...
and the phase plan. Confirm you understand the Vidya identity lock and the Vidya-cute license.
...
and the design/motion/Vidya packages scaffolded with the locked tokens and Vidya identity.
...
structure and wiring now. 5. Vidya-cute license: free choreography per page, never alter her identity (molten round
...
architecture decisions. You may freely invent implementation detail and per-page Vidya choreography.
