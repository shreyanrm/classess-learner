...
U = [
 ...
 ("TRIGONOMETRY", 12, 6, [
   ...
   ("HEIGHTS AND DISTANCES: Angle of elevation, Angle of Depression", 6, [
...
units = []
for i, (name, marks, page, items) in enumerate(U, 1):
    tops = []
    for tname, tpage, contents, comps in items:
        tops.append(topic(tname, objectives=comps,
                          source_ref=ref(M, page=tpage, section="Unit %s: %s" % (i, name)),
                          contents=contents))
    units.append(unit(name, ref(M, page=2, section="Course structure Class X, unit %d" % i),
                      topics=tops, marks=marks))
write("cbse/class-10-mathematics.json", syllabus(**FW, level="Class 10", level_order=10,
    subject="Mathematics", status="verified", documents=[DM], units=units,
...
S = "cbse-10-science"
FORMATIVE = ("Stated in the document as included in the syllabus but assessed only formatively, "
             "not in the year-end examination.")
SU = [
 ("Chemical Substances - Nature and Behaviour", 25, "Materials", 6, [
   ("Chemical Reactions and Equations",
    "Chemical reactions, Chemical equation, Balanced chemical equation, types of chemical reactions: combination, decomposition, displacement, double displacement, precipitation, endothermic exothermic reactions, oxidation and reduction.", False),
   ("Periodic Classification of Elements",
    "Döbereiner's Triads, Newlands' Law of Octaves, Mendeléev's Periodic Table, Modern Periodic Table and the Modern, Metallic and Non-metallic Properties.", True),
   ("Acids, Bases and Salts",
    "Acids and Bases - definitions in terms of furnishing of H+ and OH- ions, identification using indicators, chemical properties, examples and uses, neutralization, concept of pH scale (Definition relating to logarithm not required), importance of pH in everyday life; preparation and uses of Sodium Hydroxide, Bleaching Powder, Baking soda, Washing soda and Plaster of Paris.", True),
   ("Metals and Non-metals",
    "Properties of metals and non-metals; Reactivity series; Formation and properties of ionic compounds; Basic metallurgical processes; Corrosion and its prevention.", False),
 ...
 ("World of Living", 25, "The World of the Living", 6, [
   ("Life processes",
    "'Living Being'. Basic concept of nutrition, respiration, transport and excretion in plants and animals.", False),
   ("Control and co-ordination in animals and plants",
    "Tropic movements in plants; Introduction of plant hormones; Control and co-ordination in animals: Nervous system; Voluntary, involuntary and reflex action; Chemical co-ordination: animal hormones.", False),
   ("Reproduction",
    "Reproduction in animals and plants (asexual and sexual) reproductive health - need and methods of family planning. Safe sex vs HIV/AIDS. Child bearing and women's health.", False),
   ("Heredity",
    "Heredity; Mendel's contribution - Laws for inheritance of traits: Sex determination; brief introduction.", False),
   ("Evolution",
    "Acquired and Inherited Traits, Speciation, Evolution and Classification, Tracing Evolutionary Relationships, Fossils, Evolution by Stages, Human Evolution.", True)]),
 ("Natural Phenomena", 12, "Natural Phenomena", 7, [
   ("Reflection of light by curved surfaces",
    "Images formed by spherical mirrors, centre of curvature, principal axis, principal focus, focal length, mirror formula (Derivation not required), magnification.", False),
   ("Refraction", "Laws of refraction, refractive index.", False),
   ("Refraction of light by spherical lens",
    "Image formed by spherical lenses; Lens formula (Derivation not required); Magnification. Power of a lens.", False),
   ("Functioning of a lens in human eye",
    "Defects of vision and their corrections, applications of spherical mirrors and lenses.", True),
   ("Refraction of light through a prism",
    "Dispersion of light, scattering of light, applications in daily life (excluding colour of the sun at sunrise and sunset).", True)]),
 ("Effects of Current", 13, "How Things Work", 7, [
   ("Electric current",
    "Electric current, potential difference and electric current. Ohm's law; Resistance, Resistivity, Factors on which the resistance of a conductor depends. Series combination of resistors, parallel combination of resistors and its applications in daily life. Heating effect of electric current and its applications in daily life. Electric power, Interrelation between P, V, I and R.", False),
   ("Magnetic effects of current",
    "Magnetic field, field lines, field due to a current carrying conductor, field due to current carrying coil or solenoid; Force on current carrying conductor, Fleming's Left Hand Rule, Direct current. Alternating current: frequency of AC. Advantage of AC over DC. Domestic electric circuits.", False),
   ("Motor, Electromagnetic Induction, Electric Generator", "", True)]),
 ("Natural Resources", 5, "Natural Resources", 8, [
   ("Our environment",
    "Eco-system, Environmental problems, Ozone depletion, waste production and their solutions. Biodegradable and non-biodegradable substances.", False)]),
]
units = []
for i, (name, marks, theme, page, items) in enumerate(SU, 1):
    ...
    for tname, contents, formative in items:
        ...
        tops.append(topic(tname, source_ref=ref(S, page=page, section="Unit %s: %s" % (i, name)), **kw))
    units.append(unit(name, ref(S, page=6, section="Course structure Class X, unit %d" % i),
                      topics=tops, marks=marks, theme=theme))
write("cbse/class-10-science.json", syllabus(**FW, level="Class 10", level_order=10,
    subject="Science", status="verified", documents=[DS], units=units,
...
SS = "cbse-10-social"
SSU = [
 ("History (India and the Contemporary World-II)", 20, 1, [
   ("The Rise of Nationalism in Europe", "I", "I. Events and processes", None),
   ("Nationalism in India", "II", "I. Events and processes", None),
   ("The Making of a Global World", "III", "II. Livelihoods, Economies and Societies",
   ...
   ("The Age of Industrialisation", "IV", "II. Livelihoods, Economies and Societies",
    "To be assessed as part of Periodic Assessment only."),
   ("Print Culture and the Modern world", "V", "III. Everyday Life, Culture and politics", None)]),
 ("Geography (Contemporary India-II)", 20, 1, [
...
units = []
for i, (name, marks, page, items) in enumerate(SSU, 1):
    tops = []
    for tname, chno, section, assess in items:
        ...
        tops.append(topic(tname, source_ref=ref(SS, page=page,
                          section="Course structure, %s" % name), **kw))
    units.append(unit(name, ref(SS, page=page, section="Course structure"), topics=tops, marks=marks))
write("cbse/class-10-social-science.json", syllabus(**FW, level="Class 10", level_order=10,
    subject="Social Science", status="verified", documents=[DSS], units=units,
