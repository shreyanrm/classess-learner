...
NOTE = (
    "CBSE publishes a curriculum document only for the secondary stage (classes IX to XII). "
...
D = {
    ...
    "ncert_6_society": (
        "Exploring Society: India and Beyond, Social Science for Grade 6 (prelims)",
        19,
    ),
    "ncert_7_ganita1": (
        "Ganita Prakash, textbook of Mathematics for Grade 7, Part 1 (prelims)",
        17,
    ),
    "ncert_7_ganita2": (
        "Ganita Prakash, textbook of Mathematics for Grade 7, Part 2 (prelims)",
        17,
    ),
    "ncert_7_curiosity": ("Curiosity, textbook of Science for Grade 7 (prelims)", 19),
    "ncert_7_society1": (
        "Exploring Society: India and Beyond, Social Science for Grade 7, Part 1 (prelims)",
        21,
    ),
    "ncert_7_society2": (
        "Exploring Society: India and Beyond, Social Science for Grade 7, Part 2 (prelims)",
        15,
    ),
    "ncert_8_ganita1": (
        "Ganita Prakash, textbook of Mathematics for Grade 8, Part 1 (prelims)",
        15,
    ),
    "ncert_8_ganita2": (
        "Ganita Prakash, textbook of Mathematics for Grade 8, Part 2 (prelims)",
        15,
    ),
    "ncert_8_curiosity": ("Curiosity, textbook of Science for Grade 8 (prelims)", 19),
    "ncert_8_society1": (
        "Exploring Society: India and Beyond, Social Science for Grade 8, Part 1 (prelims)",
        21,
    ),
    "ncert_8_society2": (
        "Exploring Society: India and Beyond, Social Science for Grade 8, Part 2 (prelims)",
        17,
    ),
}
...
def book_unit(key, book_title, names):
    ...
    did = key.replace("_", "-")
    tops = [
        topic(n, source_ref=ref(did, page=page, section=f"Contents, chapter {i}"), chapter_number=i)
        for i, n in enumerate(names, 1)
    ]
    return unit(
        book_title, ref(did, page=page, section="Contents"), topics=tops, prescribed_book=book_title
    )
...
def theme_units(key, book_title, themes):
    ...
    for tt, chs in themes:
        tops = [
            topic(
                n,
                source_ref=ref(did, page=page, section=f"Contents, chapter {c}"),
                chapter_number=c,
            )
            for c, n in chs
        ]
        out.append(
            unit(
                tt,
                ref(did, page=page, section="Contents, theme heading"),
                topics=tops,
...
write(
    ...
    syllabus(
        **FW,
        ...
        status="verified",
        note=NOTE,
        documents=[D_("ncert_6_curiosity")],
        units=[
            book_unit(
                "ncert_6_curiosity",
                "Curiosity, Grade 6",
...
write(
    ...
    syllabus(
        **FW,
        ...
        status="verified",
        note=NOTE,
        documents=[D_("ncert_6_society")],
        units=theme_units(
            "ncert_6_society",
            "Exploring Society: India and Beyond, Grade 6",
            [
                (
...
write(
    ...
    syllabus(
        **FW,
        ...
        status="verified",
        note=NOTE,
        documents=[D_("ncert_7_curiosity")],
        units=[
            book_unit(
                "ncert_7_curiosity",
                "Curiosity, Grade 7",
...
write(
    ...
    syllabus(
        **FW,
        ...
        status="verified",
        note=NOTE,
        documents=[D_("ncert_8_curiosity")],
        units=[
            book_unit(
                "ncert_8_curiosity",
                "Curiosity, Grade 8",
...
write(
    "cbse/class-8-social-science.json",
    syllabus(
        **FW,
        level="Class 8",
        level_order=8,
        ...
        units=renumber(
            ...
            + theme_units(
                "ncert_8_society2",
                "Exploring Society: India and Beyond, Grade 8, Part 2",
                [
                    (
                        "Theme A - India and the World: Land and the People (Part 2)",
                    ...
                    (
                        "Theme E - Economic Life Around Us (Part 2)",
                        [
                            (6, "Dynamics of Population"),
                            (7, "India's Urban Landscape"),
