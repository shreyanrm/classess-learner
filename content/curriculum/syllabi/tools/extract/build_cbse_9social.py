...
D = doc("cbse_9_social", "Social Science, Class IX, Secondary Curriculum Part 1, 2026-27",
        "Central Board of Secondary Education")
DID = "cbse-9-social"

# (theme number, title, instructional hours, page, [outline/concept items])
P1 = [
 (1, "Understanding Social Science", 4, 8, [
    "Meaning, scope and relevance of Social Science",
    "Understanding Social Science from an Indian perspective"]),
 (2, "Shaping of the Earth's Surface", 8, 8, [
    "Theory of plate tectonics", "Interior of the Earth",
 ...
 (3, "Atmosphere and Climate", 7, 8, [
    "Structure and composition; elements of weather and climate",
    "Seasons of India and monsoons", "Climate change", "Floods", "Carbon footprint"]),
 (4, "Early Humans and Beginning of Civilisation", 9, 9, [
    "Cultural development from 2 million years ago",
    "Early human history, periodisation: Archaeological ages", "Who are human ancestors?",
 ...
 (5, "State and Society (upto 1000 CE)", 9, 9, [
 ...
 (6, "Democracy", 9, 10, [
    "Meaning features and types of democracy", "Roots of democracy in India",
    "Challenges to democracy in India", "Democratic systems in the world"]),
 (7, "Elections", 9, 10, [
    "Factors of importance of elections", "Electoral systems", "Delimitation Commission",
    "Election Commission of India and its role",
    "Constituency, electoral rolls, enumerators", "Party system in India"]),
 (8, "Building Blocks in Economics", 7, 10, [
    ...
    "Welfare economy"]),
 (9, "The Price Puzzle: What Drives the Market", 8, 11, [
...
P2 = [
 ...
 (3, "Resistance and Resilience (1000 CE - 1700 CE)", 9, 12, [
    ...
    "The Bhakti tradition", "Forts and fortifications",
    "Expansion of Indian economy and state"]),
 (4, "India and the World-I (1900 BCE - 1200 CE)", 8, 12, [
 ...
 (6, "From Ideas to Startups", 8, 13, [
    "What is entrepreneurship and explain the resources required to start a business",
    "Case studies of successful entrepreneurs", "Creative destruction with examples",
...
for part, rows in (("Part 1", P1), ("Part 2", P2)):
    for no, title, hours, page, outline in rows:
        units.append(unit(title,
            ref(DID, page=page, section="Course outline, %s, theme %d" % (part, no)),
            topics=[topic(o, source_ref=ref(DID, page=page,
                    section="Course outline, %s, theme %d, outline and concepts" % (part, no)))
                    for o in outline],
            part=part, theme_number=no, instructional_hours=hours))

write("cbse/class-9-social-science.json", syllabus(**FW, level="Class 9", level_order=9,
    subject="Social Science", status="verified", documents=[D], units=units,
