...
/**
 * WoboBody — her body, rebuilt from zero (DESIGN.md §4, owner reference 2026-07-06).
 *
...
import { flameForMood, MOLTEN, type WoboMood } from '../identity';
...
/** Body-language parameters per mood — choreography, freely tunable (the Wobo-cute license). */
interface Pose {
  wobble: number;
  speed: number;
  breathS: number;
...
const POSES: Record<WoboMood, Pose> = {
  idle: {
    wobble: 0.016,
    speed: 1,
    breathS: 3.4,
...
export function WoboBody({
  ...
  // Poke: press her back and she springs forward again, face first (the Wobo-cute license).
