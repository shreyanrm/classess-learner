...
import { fontFamily, woboHighlight, zIndex } from '@classess/config';
  ...
  return (
    ...
    >
      {bus.highlights.map((h: ActiveHighlight) => {
        ...
        const color = woboHighlight[h.level];
        const pad = 6;
            ...
            {typing && (
              <span
                ...
                style={{
                  ...
                  background: woboHighlight[n.level],
