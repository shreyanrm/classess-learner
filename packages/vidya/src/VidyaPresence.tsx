...
import { type FlameState, flameForMood, MOLTEN, type VidyaMood } from './identity';
...
/**
 * VidyaPresence — the signature tutor. A single round squircle jelly, molten and matte, with two cute
...
export function VidyaPresence({
  ...
  const dock = fixed
    ? ({ position: 'fixed', right: 24, bottom: 24, zIndex: zIndex.vidyaPresence } as const)
