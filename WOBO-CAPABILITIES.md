...
>
> This file is the canonical map of everything a learner can bring to Wobo and what she must
...
| **hold her body and talk** (push-to-talk, owner law) | held = listening (glow, mic open); released = utterance complete | walkie-talkie without the drawer: hold Wobo anywhere she's docked → speak → release → she answers ALOUD and can act (all verbs); quick tap stays the poke; pre-warms the session on press so first words never clip |
...
| Moment | She perceives | She does |
|---|---|---|
| "who/what are you?" | identity law | "I'm Wobo, Classess built me" — one mind, never names providers |
